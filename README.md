...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://portalkerja2023.vercel.app/">View Demo</a>
    ·
    <a href="/">Report Bug</a>
    ·
...
<table>
 <tr>
    ...
    <td> <img width="350px" src="./document/loginCondi.png"  border="0"  border="0"  alt="2" /></td>
  </tr>
   <tr>
    <td>Landing Page</td>
    <td>Login Condition</td>
  </tr>
    <tr>
    <td><img width="350px" src="./document/loginRec.png"  border="0" border="0" alt="3" /> </td>
     <td><img width="350px" src="./document/loginEmployer.png"  border="0" border="0" alt="4" /></td>
  </tr>
   <tr>
    <td>Login Recruiter</td>
     <td>Login Worker</td>
      ...
      <tr>
    <td><img width="350px" src="./document/registerEmployer.png"  border="0" border="0" alt="3" /> </td>
     <td><img width="350px" src="./document/registerRecruiter.png"  border="0" border="0" alt="4" /></td>
  </tr>
   <tr>
  ...
  <tr>
   ...
   <tr>
    <td>List Worker</td>
     ...
     <td><img width="350px" src="./document/updateRecruiter.png"  border="0" border="0" alt="3" /> </td>
     <td><img width="350px" src="./document/profileRecruiter.png"  border="0" border="0" alt="4" /></td>
  </tr>
   <tr>
