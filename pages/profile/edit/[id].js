...
const ProfileEdit = () => {
  ...
  const handleUpdate = (e) => {
    ...
    axios
      .put(`https://poised-boot-elk.cyclic.app/v1/user/update/${id}`, formData)
      .then(() => {
        swal({
  ...
  const handleSkill = (e) => {
    ...
    if (newSkill.name) {
      axios
        .post(`https://poised-boot-elk.cyclic.app/v1/user/skill`, newSkill)
        .then(() => {
          swal({
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://poised-boot-elk.cyclic.app/v1/user/experience`,
        formDataWithImage
      );
      swal({
        title: "Success Add",
  ...
  const handlePorto = (e) => {
    ...
    axios
      .post(`https://poised-boot-elk.cyclic.app/v1/user/portfolio`, formData)
      .then(() => {
        swal({
          title: "Success Add",
          icon: "success",
  ...
  useEffect(() => {
    axios
      .get(`https://poised-boot-elk.cyclic.app/v1/company/list`)
      .then((res) => {
